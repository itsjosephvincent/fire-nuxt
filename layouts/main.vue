                    ...
                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                        ...
                        <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
                            <TransitionChild as="template" enter="ease-in-out duration-300" enter-from="opacity-0"
                                enter-to="" leave="ease-in-out duration-300" leave-from="" leave-to="opacity-0">
                            ...
                            <div class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                                ...
                                <nav class="relative flex flex-1 flex-col">
                                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                        <li>
                                            <ul role="list" class="-mx-2 space-y-1">
                                                <li v-for="item in navigation" :key="item.name">
                                                    <a :href="item.href"
                                                        :class="[item.current ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600', 'group flex gap-x-3 rounded-md p-2 text-lg font-semibold']">
                                        ...
                                        <li>
                                            ...
                                            <ul role="list" class="-mx-2 mt-2 space-y-1">
                                                <li v-for="team in teams" :key="team.name">
                                                    <a :href="team.href"
                                                        :class="[team.current ? 'bg-gray-50 text-indigo-600' : 'text-gray-700 hover:bg-gray-50 hover:text-indigo-600', 'group flex gap-x-3 rounded-md p-2 text-lg font-semibold']">
                                                        <span
                                        ...
                                        <li class="mt-auto">
                                            <a href="#"
                                                class="group -mx-2 flex gap-x-3 rounded-md p-2 text-lg font-semibold text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                                                <Cog6ToothIcon
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
                ...
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        ...
                        <li class="mt-auto" v-if="state.isAdmin">
                            <a href="#"
                                class="group -mx-2 flex gap-x-3 rounded-md p-2 text-lg font-semibold text-gray-700 hover:bg-gray-50 hover:text-indigo-600">
                        ...
                        <Menu as="div" class="relative">
                            <MenuButton class="relative flex items-center">
                                ...
                                <span class="hidden lg:flex lg:items-center">
                                    <span class="ml-4 text-lg font-semibold text-gray-900" aria-hidden="true">
                                        Tom Cook
                                    </span>
                            ...
                            <transition enter-active-class="transition ease-out duration-100"
                                ...
                                <MenuItems
                                    ...
                                    <MenuItem>
                                    <NuxtLink @click=""
                                        :class="[active ? 'bg-gray-50 outline-none' : '', 'block px-3 py-1 text-lg text-gray-900 cursor-pointer']">
                                        Profile
                                    </NuxtLink>
                                    </MenuItem>
                                    <MenuItem>
